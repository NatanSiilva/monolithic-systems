...
describe("PlaceOrderUseCase unit tests", () => {
    ...
    describe("getProducts method", () => {
        ...
        it("should throw an error when products are not found", async () => {
            const mocCatalogFacade = {
                find: jest.fn().mockResolvedValue(null),
            };

            //@ts-expect-error - force set catalogFacade
            placeOrderUseCase["_catalogFacade"] = mocCatalogFacade;
        ...
        it("should return a product", async () => {
            ...
            await expect(placeOrderUseCase["getProduct"]("0")).resolves.toEqual(
                new Product({
                    id: new Id(mockProduct.id),
                    name: mockProduct.name,
                    description: mockProduct.description,
                    salesPrice: mockProduct.salesPrice,
                })
            );
    ...
    describe("execute method", () => {
        ...
        describe("place an order", () => {
            ...
            it("should not be approved", async () => {
                ...
                expect(mockCheckoutRepository.addOrder).toHaveBeenCalledTimes(
                    1
                );
